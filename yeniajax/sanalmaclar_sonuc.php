...
if($_GET['sonucgiris']==1){

## FUTBOL V2 SONUÇLARI ##

$sor_vflm = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vflm_v2' and iy_ev='' and iy_dep='' and ms_ev='' and ms_dep='' group by sezon_hafta order by sezonid ASC");

while($row_vflm=sed_sql_fetcharray($sor_vflm)){

$js_vflm = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=futbolv2&sezonid=".$row_vflm['sezonid']."&hafta=".$row_vflm['hafta']."");
...
$sor_vfct = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vfct_v2' and iy_ev='' and iy_dep='' and ms_ev='' and ms_dep='' group by sezon_hafta order by sezonid ASC");

while($row_vfct=sed_sql_fetcharray($sor_vfct)){

$js_vfct = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=turkiye&sezonid=".$row_vfct['sezonid']."&hafta=".$row_vfct['hafta']."");
...
$sor_vfcc = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vfcc_v2' and iy_ev='' and iy_dep='' and ms_ev='' and ms_dep='' group by sezonid order by sezonid ASC");

while($row_vfcc=sed_sql_fetcharray($sor_vfcc)){

$js_vfcc = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=sampiyonlar&sezonid=".$row_vfcc['sezonid']."");
...
$sor_vfwc = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vfwc_v2' and iy_ev='' and iy_dep='' and ms_ev='' and ms_dep='' group by sezonid order by sezonid ASC");

while($row_vfwc=sed_sql_fetcharray($sor_vfwc)){

$js_vfwc = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=dunya&sezonid=".$row_vfwc['sezonid']."");
...
$sor_vfec = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vfec_v2' and iy_ev='' and iy_dep='' and ms_ev='' and ms_dep='' group by sezonid order by sezonid ASC");

while($row_vfec=sed_sql_fetcharray($sor_vfec)){

$js_vfec = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=avrupa2020&sezonid=".$row_vfec['sezonid']."");
...
$sor_vbl = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vbl_v2' and iy_ev='' and iy_dep='' and ms_ev='' and ms_dep='' group by sezon_hafta order by sezonid ASC");

while($row_vbl=sed_sql_fetcharray($sor_vbl)){

$js_vbl = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=basketbol&sezonid=".$row_vbl['sezonid']."&hafta=".$row_vbl['hafta']."");
...
$sor_vhc = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vhc_v2' and at_1='0' and at_2='0' and at_3='0' group by sezon_hafta order by sezonid ASC");

while($row_vhc=sed_sql_fetcharray($sor_vhc)){

$js_vhc = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=at&sezonid=".$row_vhc['sezonid']."&sezon=".$row_vhc['sezon']."");
...
$sor_vdr = sed_sql_query("select * from kupon_ic_sanal where kazanma='1' and spor_tip='vdr_v2' and at_1='0' and at_2='0' and at_3='0' group by sezon_hafta order by sezonid ASC");

while($row_vdr=sed_sql_fetcharray($sor_vdr)){

$js_vdr = curlfonksiyon("https://betwingo.xyz/api/sanalmaclar_sonuc.php?tip=kopek&sezonid=".$row_vdr['sezonid']."&sezon=".$row_vdr['sezon']."");
...
## FUTBOL SONUÇLARI ##
function futbol_sonuc($birincigol,$iy_ev,$iy_dep,$ms_ev,$ms_dep,$oran_tip,$oran_val) {
...
$sonucgetir_futbol = futbol_sonuc($row['birincigol'],$row['iy_ev'],$row['iy_dep'],$row['ms_ev'],$row['ms_dep'],$row['oran_tip'],$row['oran_val']);
...
## BASKETBOL SONUÇLARI ##
function basketbol_sonuc($set_1,$set_2,$set_3,$set_4,$set_5,$kazanan_20,$kazanan_40,$kazanan_60,$oran_tip,$oran_val) {
...
$sonucgetir_basketbol = basketbol_sonuc($row_vbl['set_1'],$row_vbl['set_2'],$row_vbl['set_3'],$row_vbl['set_4'],$row_vbl['set_5'],$row_vbl['kazanan_20'],$row_vbl['kazanan_40'],$row_vbl['kazanan_60'],$row_vbl['oran_tip'],$row_vbl['oran_val']);
