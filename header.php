...
<li id="depositLink">
<a data-qa="navigationLayerdeposit" href="#">
Para Yatırma
</a>
</li>
<li id="withdrawalLink">
<a data-qa="navigationLayerdeposit" href="#">
Para Çekme
</a>
</li>
<li id="personalLink">
<a data-qa="navigationLayerpersonalLink" href="personaldetails">
Bilgilerim
</a>
</li>
...
<? } else { ?>
<li id="mybetsLink">
<a data-qa="navigationLayerMyBets" href="players/kuponlarim.php">
...
<div id="myBets">
<a href="players" style="background: url(img/header/payin.png) no-repeat center top 5px;"><?=getTranslation('hesabim')?></a>
<span id="comp-openTicketCount2" class="e_active e_noCache ">
</span>
</div>
