...
<li class="breadcrumb-item">Masa Tenisi Sonuç Giriş</li>
</ol>
...
<?
$gecenler = time()-6000;
$sor = sed_sql_query("select * from kupon_ic where kazanma='1' and spor_tip='masatenisi' and mac_time<$gecenler group by mac_db_id order by mac_time asc");
if(sed_sql_numrows($sor)<1) { ?>

<table class="table table-striped mb-0">
<thead>
<tr>
<th style="width: 25%">M.Tenisi * Bahis</th>
...
$.get('index.php?s=ertelemasatenisi&rand='+rand+'&macid='+id+'',function(data) {
alert('Maç Ertelendi');
...
$.get('index.php?s=skorgirmasatenisi&rand='+rand+'&macid='+id+'&p1_ev='+p1_ev+'&p1_dep='+p1_dep+'',function(data) {
