...
<li class="breadcrumb-item">Buz Hokeyi Sonuç Giriş</li>
</ol>
...
<?
$gecenler = time()-6000;
$sor = sed_sql_query("select * from kupon_ic where kazanma='1' and spor_tip='buzhokeyi' and mac_time<$gecenler group by mac_db_id order by mac_time asc");
...
$.get('index.php?s=ertelebuzhokeyi&rand='+rand+'&macid='+id+'',function(data) {
alert('Maç Ertelendi');
...
$.get('index.php?s=skorgirbuzhokeyi&rand='+rand+'&macid='+id+'&p1_ev='+p1_ev+'&p2_ev='+p2_ev+'&p3_ev='+p3_ev+'&p1_dep='+p1_dep+'&p2_dep='+p2_dep+'&p3_dep='+p3_dep+'',function(data) {
