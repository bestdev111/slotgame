...
<li class="breadcrumb-item">Canlı Voleybol Sonuç Giriş</li>
</ol>
...
<?
$gecenler = time()-6000;
$sor = sed_sql_query("select * from kupon_ic where kazanma='1' and spor_tip='canliv' and mac_time<$gecenler group by mac_db_id order by mac_time asc");
if(sed_sql_numrows($sor)<1) { ?>

<table class="table table-striped mb-0">
<thead>
<tr>
<th style="width: 20%">Voleybol * Bahis</th>
...
$.get('index.php?s=ertelecanlivoleybol&rand='+rand+'&macid='+id+'',function(data) {
alert('Maç Ertelendi');
...
$.get('index.php?s=skorgircanlivoleybol&rand='+rand+'&macid='+id+'&p1_ev='+p1_ev+'&p2_ev='+p2_ev+'&p3_ev='+p3_ev+'&p4_ev='+p4_ev+'&p5_ev='+p5_ev+'&p1_dep='+p1_dep+'&p2_dep='+p2_dep+'&p3_dep='+p3_dep+'&p4_dep='+p4_dep+'&p5_dep='+p5_dep+'',function(data) {
