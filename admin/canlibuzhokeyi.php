...
<li class="breadcrumb-item">Canlı Buz Hokeyi Sonuç Giriş</li>
</ol>
...
<?
$gecenler = time()-6000;
$sor = sed_sql_query("select * from kupon_ic where kazanma='1' and spor_tip='canlibuz' and mac_time<$gecenler group by mac_db_id order by mac_time asc");
if(sed_sql_numrows($sor)<1) { ?>

<table class="table table-striped mb-0">
<thead>
<tr>
<th style="width: 20%">Buz Hokeyi * Bahis</th>
...
$.get('index.php?s=ertelecanlibuzhokeyi&rand='+rand+'&macid='+id+'',function(data) {
alert('Maç Ertelendi');
...
$.get('index.php?s=skorgircanlibuzhokeyi&rand='+rand+'&macid='+id+'&p1_ev='+p1_ev+'&p2_ev='+p2_ev+'&p3_ev='+p3_ev+'&p1_dep='+p1_dep+'&p2_dep='+p2_dep+'&p3_dep='+p3_dep+'',function(data) {
