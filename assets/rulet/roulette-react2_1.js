...
var Roulette = function (_React$Component) {
  ...
  _createClass(Roulette, [{
    ...
    value: function fetchData() {
      ...
      fetch('/yeniajax/ruletjson2.php?cmd=RuletBilgisi').then(function (res) {
        return res.json();
    ...
    value: function repeatBets(id) {
      ...
      fetch('/yeniajax/ruletjson2.php?cmd=KuponTekrarla&id=' + id).then(function (res) {
        return res.json();
      }).then(function (result) {
        _this4.setState({
          coupon: result.coupon,
    ...
    value: function clearCoupon() {
      ...
      fetch('/yeniajax/ruletjson2.php?cmd=KuponTemizle', {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
    ...
    value: function play(auto) {
      ...
      formData.append('coupon_type', 'roulette');
      fetch('/yeniajax/ruletjson2.php?cmd=PlayBilgisi' + (auto ? '&auto=true' : ''), {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
    ...
    value: function removeBet(key) {
      ...
      fetch('/yeniajax/ruletjson2.php?cmd=KuponSil', {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
    ...
    value: function makeBet() {
      ...
      fetch('/yeniajax/ruletjson2.php?cmd=KuponEkle', {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
