...
var Roulette = function (_React$Component) {
  ...
  _createClass(Roulette, [{
    ...
    value: function fetchData() {
      ...
      fetch('https://jackpotmatic.store/yeniajax/ruletjson2.php?cmd=RuletBilgisi').then(function (res) {
        return res.json();
    ...
    value: function repeatBets(id) {
      ...
      fetch('https://jackpotmatic.store/yeniajax/ruletjson2.php?cmd=KuponTekrarla&id=' + id).then(function (res) {
        return res.json();
      }).then(function (result) {
        _this4.setState({
          coupon: result.coupon,
        ...
        source: {
          entries: [{
            bintu: {
              ...
              streamid: "a4198305-1734-461a-be3e-99e5ce9636a3"
            }
          }]
        },
        playback: {
    ...
    value: function clearCoupon() {
      ...
      fetch('https://jackpotmatic.store/yeniajax/ruletjson2.php?cmd=KuponTemizle', {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
    ...
    value: function play(auto) {
      ...
      formData.append('coupon_type', 'roulette');
      fetch('https://jackpotmatic.store/yeniajax/ruletjson2.php?cmd=PlayBilgisi' + (auto ? '&auto=true' : ''), {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
    ...
    value: function removeBet(key) {
      ...
      fetch('https://jackpotmatic.store/yeniajax/ruletjson2.php?cmd=KuponSil', {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
    ...
    value: function makeBet() {
      ...
      fetch('https://jackpotmatic.store/yeniajax/ruletjson2.php?cmd=KuponEkle', {
        method: 'POST',
        body: formData
      }).then(function (res) {
        return res.json();
            ...
            React.createElement(
              ...
              !this.state.auto ? this.state.remaining < 1 ? React.createElement(
                ...
                React.createElement(
                  ...
                  !this.state.playing ? ''+ruletdil27+'' : React.createElement('i', { className: 'fas fa-spinner fa-pulse' })
                )
              ) : ''
            )
          )
