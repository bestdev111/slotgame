...
tmpb.push('<div class="qbut qbut-'+qbut+'" oddsid="'+o.brid+'" onclick="canliekle(\'Toplam Skor Alt/Üst\',\''+o.tercih+'\',\''+o.oran+'\',\''+k+'\',\''+Live.bets[k].spid+'\');void(0);" style="margin-right: 8px;">'+o.oran+'</div>');
}
});
tmpb.push('</div>');
} else {
...
tmpt.push('<div class="qbut qbut-'+qbut+'" oddsid="'+o.brid+'" onclick="canliekle(\'Kim Kazanır\',\''+o.tercih+'\',\''+o.oran+'\',\''+k+'\',\''+Live.bets[k].spid+'\');void(0);">'+o.oran+'</div>');
