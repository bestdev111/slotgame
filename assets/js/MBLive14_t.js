...
mobilgenesibas[mp]+='<div class="'+k+' qbutton qbut-'+qbut+' '+o.image+'" oddsid="'+k+''+o.brid+'" onclick="canliekle('+k+''+o.brid+',\''+Bahis.oyunlar[170].ad+'\',\''+o.tercih+'\',\''+o.oran+'\',\''+k+'\',\''+Live.bets[k].spid+'\', this);void(0);">';
...
return "geris";
		...
		mobilehtml += '<div class="cell rsDesc w'+widthnewgame+'">'+l.oyunad+'</div>'+addwidthnewgame;
 		...
 		mobilehtml += '<div class="'+Live.Details.eventid+' qbutton r qbut-'+qbut+'" oddsid="'+Live.Details.eventid+''+orankodu+'_'+oyunad+'" onclick="javascript:canliekle(\''+Live.Details.eventid+''+orankodu+'_'+oyunad+'\',\''+oyunad+'\',\''+(Bahis.idcol[idc] && Bahis.idcol[idc].kadtercih ? Bahis.idcol[idc].kadtercih:Live.GameTranslate(tercih))+'\',\''+oran+'\',\''+Live.Details.eventid+'\',\''+oyunspid+'\', this);">';
