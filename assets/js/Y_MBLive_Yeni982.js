 var Live = {
     ...
     menuserver: '/ajax/root_liste_mobil_dil.php',
     interval: null,
     refresh: 10 * 1000,
     oldscores: {},
     bets: {},
...
{
mobilgenesimtenis[mp]+='<div class="cell rsDesc w50">'+canliicin_masatenisi_oran+'</div>';
...
if(Live.bets[k].games[170] && Live.bets[k].games[170].count==2 && Live.bets[k].games[170].statu)
{
mobilgenesitenis[mp]+='<div class="cell rsDesc w50">'+canliicin_tenis_oran+'</div>';
$.each(Live.bets[k].games[170].oranlar, function(n, o) {
if(o.statu)
{
...
if(Live.bets[k].games[170] && Live.bets[k].games[170].count==2 && Live.bets[k].games[170].statu)
{
mobilgenesibas[mp]+='<div class="cell rsDesc w50">'+canliicin_basket_oran+'</div>';
$.each(Live.bets[k].games[170].oranlar, function(n, o) {
if(o.statu)
{
...
mobilgenesi[mp]+='<div> '+(Live.bets[k].pid=="2" ? ''+devreler46+'':''+Live.bets[k].diff+'\'')+' </div><img src="assets/img/icons/live_rain.png" alt="" width="23" height="23" class="hidden"><span class=""> <img src="assets/img/icon_liveRunning_red.gif" alt="" width="24" height="12"> </span></div>';
mobilgenesi[mp]+='</div>';
}
...
if(b.count>2){
mobilgenesi[mp]+='<div class="cell rsDesc w25">'+b.oyunad2+'</div>';
} else if(b.count<3){
mobilgenesi[mp]+='<div class="cell rsDesc w50">'+b.oyunad2+'</div>';
}
...
mobilgenesi[mp]+='<div class="caption">'+o.tercih2+'</div>';
mobilgenesi[mp]+='<div class="quote">'+o.oran+'</div>';
mobilgenesi[mp]+='</div>';
mobilgenesi[mp]+='</div>';
} else {
mobilgenesi[mp]+='<div class="cell w25 rsBut">';
mobilgenesi[mp]+='<div class="qbutton r stopped">';
mobilgenesi[mp]+='<div class="caption">'+o.tercih2+'</div>';
mobilgenesi[mp]+='<div class="quote">'+o.oran+'</div>';
mobilgenesi[mp]+='</div>';
mobilgenesi[mp]+='</div>';
...
if(Live.bets[k].games[170] && Live.bets[k].games[170].count==2 && Live.bets[k].games[170].statu)
{
mobilgenesivoleybol[mp]+='<div class="cell rsDesc w50">'+canliicin_voleybol_oran+'</div>';
$.each(Live.bets[k].games[170].oranlar, function(n, o) {
if(o.statu)
{
...
{
mobilgenesibuzhokeyi[mp]+='<div class="cell rsDesc w50">'+canliicin_buzhokeyi_oran+'</div>';
...
$('.evetnliveadded').html('<div class="msg_groupError"><div class="space_2">&nbsp;</div><div class="msgtext Notice"><div class="text">'+canlibulunmadifutbol+'</div></div></div>');
}
...
$('.evetnliveaddedvoleybol').html('<div class="msg_groupError"><div class="space_2">&nbsp;</div><div class="msgtext Notice"><div class="text">'+canlibulunmadivoleybol+'</div></div></div>');
}
...
$('.evetnliveaddedbuzhokeyi').html('<div class="msg_groupError"><div class="space_2">&nbsp;</div><div class="msgtext Notice"><div class="text">'+canlibulunmadibuzhokeyi+'</div></div></div>');
}
...
$('.evetnliveaddedbasket').html('<div class="msg_groupError"><div class="space_2">&nbsp;</div><div class="msgtext Notice"><div class="text">'+canlibulunmadibasketbol+'</div></div></div>');
}
...
$('.evetnliveaddedmtennis').html('<div class="msg_groupError"><div class="space_2">&nbsp;</div><div class="msgtext Notice"><div class="text">'+canlibulunmadimasatenisi+'</div></div></div>');
}
...
$('.evetnliveaddedtennis').html('<div class="msg_groupError"><div class="space_2">&nbsp;</div><div class="msgtext Notice"><div class="text">'+canlibulunmaditenis+'</div></div></div>');
}
...
mesajMobil+='</div>';
	...
	ScoreParservoleybol: function(data) {
		...
		Live.Details.lastminute=minute;
	     ...
	     if($skor.pid==2)
	     {
             $('#time_'+Live.Details.eventid+',#score-panel-1 #time').text(''+devreler46+'');
	     }else{
...
return "geris";
		 ...
		 mobilehtml += '<div id="rsg'+m+'" class="rsGroup" style="'+(!Live.Details.kapatilanlar[m] ? '':'display:none;')+'">';
			     ...
			     if (!marketoyunlar[m][mi].gstatu || !marketoyunlar[m][mi].count>0) {
                                 Live.Details.Template.Suspended(marketoyunlar[m][mi].oyunad2);
                             } else {
		 ...
		 mobilehtml += '</div>';
				...
				kuponguncelle();
                 if (!playing) {
                     this.Debug(''+oranlarkapatildiyazisi+'');
                 } else {
                     this.Debug('');
                 }
                 this.SetToggle();
		...
		mobilehtml += '<div class="cell rsDesc w'+widthnewgame+'">'+l.oyunad2+'</div>'+addwidthnewgame;
		     jQuery.each(l.oranlar, function(a, b) {
                     image = Live.Details.OddsArrow(b.brid, b.oran);
if(b.oran>1){
Live.Details.Template.SetTd(b.brid, l.oyunad, b.oran, b.tercih, b.tercih2, k.spid, image,l.gid,stunista,b.idc);
}else{
Live.Details.Template.SetTdsus(b.tercih, b.tercih2, b.oran, sutun);
}
	        ...
	        mobilehtml += '<div class=""></div></div>';
             ...
             SetTd: function(orankodu, oyunad, oran, tercih, tercih2, oyunspid, image,gid,stunista,idc) {
	     var oyungenis = "76";
	     var orangenis = "30";
 		...
 		mobilehtml += '<div class="caption">'+(Bahis.idcol[idc] && Bahis.idcol[idc].kadtercih ? Bahis.idcol[idc].kadtercih:Live.GameTranslate(tercih2))+'</div>';
 		mobilehtml += '<div class="quote">' + oran + '</div>';
 		mobilehtml += '</div>';
 		mobilehtml += '</div>';
     	    },
			SetTdsus: function(tercih,tercih2,oran) {
                 mobilehtml += '<div class="cell w25 rsBut"><div class="qbutton r stopped"><div class="caption">' + Live.GameTranslate(tercih2) + '</div><div class="quote">' + oran + '</div></div></div>';
             },
