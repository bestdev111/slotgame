...
if(userayar('rulet_oynama')!='1') { header("Location:index.php"); }
?>
...
<script src=https://demo.nanocosmos.de/nanoplayer/api/release/nanoplayer.4.min.js?20200330></script>
...
<script src="assets/rulet/roulette-react2_1_y.js?v=2.055s"></script>
