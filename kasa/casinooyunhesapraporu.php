...
<li class="breadcrumb-item"><?=getTranslation('yeniyerler_kasa118')?> | <i><?=getTranslation('yeniyerler_kasa119')?></i> </li>
</ol>
...
$.get('../ajax_superadmin.php?a=casinooyunhesaprapor&rand='+rand+'&tarih1='+tarih1+'&tarih2='+tarih2+'',function(data) { $("#kupons").html(data); });
}
