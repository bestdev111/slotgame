...
<li class="breadcrumb-item"><?=getTranslation('yeniyerler_kasa81')?></li>
</ol>
...
<div class="col-sm-3">
<input type="text" class="form-control pickadate picker__input tcal tcalInput" id="tarih1" name="tarih1" autocomplete="off" value="<?=date("01-m-Y"); ?>" style="text-align:center;">
</div>

<div class="col-sm-3">
<input type="text" class="form-control pickadate picker__input tcal tcalInput" id="tarih2" name="tarih2" autocomplete="off" value="<?=date("d-m-Y"); ?>" style="text-align:center;">
</div>
...
$.get('../ajax_superadmin.php?a=bakiyeraporu&tarih1='+tarih1+'&tarih2='+tarih2+'',function(data) { $("#kupons").html(data); });
}
