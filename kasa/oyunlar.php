...
<li class="breadcrumb-item"><?=getTranslation('yeniyerler_kasa181')?></li>
</ol>
...
<select style="float: left;width:60%;" class="form-control" onChange="oyunturleri($(this).val());">
...
$.get('../ajax_superadmin.php?a=oyun_turleri&tip='+tip+'&rand='+rand+'',function(data) { 
