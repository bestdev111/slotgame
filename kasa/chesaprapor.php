...
<li class="breadcrumb-item"><?=getTranslation('yeniyerler_kasa508')?></li>
</ol>
...
$.get('../ajax_superadmin.php?a=chesapraporlar&rand='+rand+'&userid='+userid+'&tarih1='+tarih1+'&tarih2='+tarih2+'',function(data) { $("#kupons").html(data); });
}
