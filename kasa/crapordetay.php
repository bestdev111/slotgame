...
<li class="breadcrumb-item"><?=getTranslation('yeniyerler_kasa509')?></li>
</ol>
...
$.get('../ajax_superadmin.php?a=crapordetay&rand='+rand+'&userid='+userid+'&tarih1='+tarih1+'&tarih2='+tarih2+'',function(data) { $("#kupons").html(data); });
}
