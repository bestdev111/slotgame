...
$oran_visible = $oranlar->o;
if($oran_visible=="true"){
$json['veriler']['oranlar'][] = array("GameTemplateId"=>"2","detay"=>"Set Bahisi","oran_adi_1"=>"3:0","oran1"=>$oran1,"visible1"=>$visible1,"oran_adi_2"=>"3:1","oran2"=>$oran2,"visible2"=>$visible2,"oran_adi_3"=>"3:2","oran3"=>$oran3,"visible3"=>$visible4,"oran_adi_4"=>"2:3","oran4"=>$oran4,"visible4"=>$visible4,"oran_adi_5"=>"1:3","oran5"=>$oran5,"visible5"=>$visible5,"oran_adi_6"=>"0:3","oran6"=>$oran6,"visible6"=>$visible6);
}
...
$oran_visible = $oranlar->o;
if($oran_visible=="true"){
$json['veriler']['oranlar'][] = array("GameTemplateId"=>"3","detay"=>"1.Seti Kim Kazanır","oran_adi_1"=>"1","oran1"=>$oran1,"visible1"=>$visible1,"oran_adi_2"=>"2","oran2"=>$oran2,"visible2"=>$visible2);
}
...
$oran_visible = $oranlar->o;
if($oran_visible=="true"){
$json['veriler']['oranlar'][] = array("GameTemplateId"=>"4","detay"=>"2.Seti Kim Kazanır","oran_adi_1"=>"1","oran1"=>$oran1,"visible1"=>$visible1,"oran_adi_2"=>"2","oran2"=>$oran2,"visible2"=>$visible2);
}
...
$oran_visible = $oranlar->o;
if($oran_visible=="true"){
$json['veriler']['oranlar'][] = array("GameTemplateId"=>"5","detay"=>"3.Seti Kim Kazanır","oran_adi_1"=>"1","oran1"=>$oran1,"visible1"=>$visible1,"oran_adi_2"=>"2","oran2"=>$oran2,"visible2"=>$visible2);
}
...
$oran_visible = $oranlar->o;
if($oran_visible=="true"){
$json['veriler']['oranlar'][] = array("GameTemplateId"=>"6","detay"=>"4.Seti Kim Kazanır","oran_adi_1"=>"1","oran1"=>$oran1,"visible1"=>$visible1,"oran_adi_2"=>"2","oran2"=>$oran2,"visible2"=>$visible2);
}
...
$oran_visible = $oranlar->o;
if($oran_visible=="true"){
$json['veriler']['oranlar'][] = array("GameTemplateId"=>"7","detay"=>"5.Seti Kim Kazanır","oran_adi_1"=>"1","oran1"=>$oran1,"visible1"=>$visible1,"oran_adi_2"=>"2","oran2"=>$oran2,"visible2"=>$visible2);
}
