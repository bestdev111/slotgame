...
<div class="icon selected" onclick="getle('sport99')"><div class="sports soccer"></div><span><?=getTranslation('mobilfutbol')?></span></div>
...
<div class=" navitem arrow" onclick="getle('today')"> <div class="icon"> <div class="sports today"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsportsulkebugun')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>
...
$.get('export.php?a=futbolulkeler',function(data) {
