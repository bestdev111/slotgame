...
if(userayar('tenis')!="1") { header("Location:/mb"); }
?>
...
<? } ?>
<div class="icon selected" onclick="getle('todayt')"><div class="sports today"></div><span><?=getTranslation('mobilbugun')?></span></div>
...
$("#loadbultenbugun").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
var rand = Math.random();
$.get('export.php?a=tenisbugun&rand='+rand+'',function(data) {
...
$("#loadbultenbugun").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$(".filterbar").hide();
$.get('export_detail.php?a=tenis&id='+id+'',function(data) {
$("#loadbultenbugun").html(data);
});
}
