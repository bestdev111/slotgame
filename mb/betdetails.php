...
<script>$("#baslikdivi").html('<span><?=getTranslation('mobilbetdetailsheaderdiv')?></span>');</script>
...
<div id="appcontent3" class="appcontent" style="display:none;">
<div>  </div>
<div class="betfilterbar">
<div id="preload1" class="cell w25 selected preload1" onclick="hesapozetle(1);"> <div class="text"><?=$suanay_ver;?></div></div>
<div id="preload2" class="cell w25  preload1" onclick="hesapozetle(2);"> <div class="text"><?=$biray_ver;?></div></div>
...
if(val==1){
	...
	$.get('export.php?a=kuponraporum&tarih_ver=<?=$suanayveyil1_ver;?>&tarih_ver2=<?=$suanayveyil2_ver;?>&islemtip='+islemtip+'',function(data) {
	...
	$("#preload3").removeClass("selected");
	$("#preload4").removeClass("selected");
	$.get('export.php?a=kuponraporum&tarih_ver=<?=$birayveyil1_ver;?>&tarih_ver2=<?=$birayveyil2_ver;?>&islemtip='+islemtip+'',function(data) {
	$("#hesapozeti").html(data);
	});
} else if(val==3){
	var islemtip = $("#islemtip1").val();
	...
	$("#preload4").removeClass("selected");
	$.get('export.php?a=kuponraporum&tarih_ver=<?=$ikiayveyil1_ver;?>&tarih_ver2=<?=$ikiayveyil2_ver;?>&islemtip='+islemtip+'',function(data) {
	$("#hesapozeti").html(data);
	});
} else {
	var gun1 = $("#gun1").val();
	...
	$("#appcontent2").hide();
	$("#appcontent3").hide();
	$.get('export.php?a=kuponraporum&tarih_ver='+tarih_ver+'&tarih_ver2='+tarih_ver2+'&islemtip='+islemtip+'',function(data) {
	$("#hesapozeti").html(data);
	});
