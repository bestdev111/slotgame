...
<? } ?>
<? if(userayar('tenis')=="1") { ?>
<div class="icon selected" onclick="getle('sport3')"><div class="sports tennis"></div><span><?=getTranslation('mobiltenis')?></span></div>
<? } ?>
...
if(val==1){
	...
	$.get('export.php?a=livesearch_arama&sportip=3&aranan_takim='+aranan_takim+'',function(data) {
...
function loadbulten() {
$("#loadbulten").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$.get('export.php?a=tenisbulten&lig=<?=$_GET['lig'];?>',function(data) {
