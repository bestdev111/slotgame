...
if(userayar('dovus')!="1") { header("Location:/mb"); }
?>
...
<? } ?>
<? if(userayar('dovus')=="1") { ?>
<div class="icon selected" onclick="getle('sport12')"><div class="sports boxing"></div><span><?=getTranslation('yeniyerler_kasa199')?></span></div>
<? } ?>
...
function loadbulten() {
$("#loadbulten").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$.get('export.php?a=dovusbulten',function(data) {
