...
<? } ?>
<div class="icon selected" onclick="getle('todayb')"><div class="sports today"></div><span><?=getTranslation('mobilbugun')?></span></div>
...
$.get('export.php?a=basketbolbugun&rand='+rand+'',function(data) {
