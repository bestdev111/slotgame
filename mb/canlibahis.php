...
<div class="evetnliveadded">
<div id="loadings" class="old" style="text-align:center;margin-top:5%;">
<div class="spinner"><img src="/mb/img/loading_x6_blueto.gif" onload="displayImage(this)"></div>
</div>
</div>
<? if(userayar('canlibasketbol')=="1") { ?>
