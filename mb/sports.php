...
<div class="icon " onclick="getle('/mb/sanal-spor')"><div class="filterIcon categories casinoQuickFilterIcon2"></div><span>Sanal Spor</span></div>
<? } ?>
...
<div class=" navitem arrow" onclick="getle('liveengelli')"> <div class="icon"> <div class="sports live"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsports1')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>
<? } else { ?>
<div class=" navitem arrow" onclick="getle('live')"> <div class="icon"> <div class="sports live"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsports1')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>
<? } ?>

<div class=" navitem arrow" onclick="getle('today')"> <div class="icon"> <div class="sports today"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsports2')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>

<? if(userayar('canlifutbol')!="1") { ?>
<div class=" navitem arrow" onclick="getle('liveengelli')"> <div class="icon"> <div class="sports highlights"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsports3')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>

<div class=" navitem arrow" onclick="getle('liveengelli')"> <div class="icon"> <div class="sports lastminute"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsports4')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>
<? } else { ?>
<div class=" navitem arrow" onclick="getle('live')"> <div class="icon"> <div class="sports highlights"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsports3')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>

<div class=" navitem arrow" onclick="getle('live')"> <div class="icon"> <div class="sports lastminute"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsports4')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>
<? } ?>
...
$.get('export.php?a=sporbahisleri',function(data) {
