...
$(document).ready(function(){   
	$(".replace").on("keyup", function(){
			str = $(this).val();
			var dizi = { "İ": "i", "Ş": "s", "Ğ": "g", "Ü": "u", "Ö": "o", "Ç": "c",  "ş": "s", "ğ": "g", "ü": "u", "ö": "o", "ç": "c", "ı": "i", " ": "" };
			str = str.replace(/(([İŞĞÜÖÇşğüöçı ]))+/g, function(harf){ return dizi[harf]; })
			$(this).val(str);
	});   
});

WebFontConfig = {
    google: { families: [ 'Open+Sans:400,600,700,800:latin,latin-ext' ] }
  };
  (function() {
