...
<div class=" navitem arrow" onclick="getle('todayb')"> <div class="icon"> <div class="sports today"></div> <span class="hidden c "></span> </div> <div class="text"><?=getTranslation('mobilsportsulkebugun')?></div><div class="value"><div class="count normal hidden">&gt;</div></div></div>
...
$.get('export.php?a=basketbolulkeler',function(data) {
