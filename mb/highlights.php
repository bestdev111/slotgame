...
if(userayar('beyzbol')!="1") { header("Location: mb"); }
?>
...
<div class="icon " onclick="getle('/sanal-spor')"><div class="filterIcon categories casinoQuickFilterIcon2"></div><span>Sanal Spor</span></div>
<? } ?>
...
<div class="icon selected" onclick="getle('sport10')"><div class="sports baseball"></div><span><?=getTranslation('yeniyerler_kasa197')?></span></div>
<? } ?>
<? if(userayar('rugby')=="1") { ?>
...
if(val==1){
	...
	$.get('export_deneme.php?a=livesearch_arama&sportip=3&aranan_takim='+aranan_takim+'',function(data) {
...
function loadbulten() {
$("#loadbulten").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$.get('export.php?a=highlightsmaclar',function(data) {
