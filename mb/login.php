...
$paswd = pd("password");
	...
	$zaman = time();
$kontrol = sed_sql_query("select * from kullanici where username='$uname' and password='$paswd' and root='0'");
...
<div class="container">
    <div id="login" class="login">
		...
		<button><a href="register"><font color="white">KAYIT OL</font>
        <p></p>
        </div>
