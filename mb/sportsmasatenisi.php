...
if(userayar('masatenisi')!="1") { header("Location:/mb"); }
?>
...
<div class="icon selected" onclick="getle('sport9')"><div class="sports table-tennis"></div><span><?=getTranslation('yeniyerler_kasa179')?></span></div>
<? } ?>
...
function loadbulten() {
$("#loadbulten").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$.get('export.php?a=masatenisbulten',function(data) {
