...
if(userayar('voleybol')!="1") { header("Location:/mb"); }
?>
...
<div class="icon selected" onclick="getle('sport4')"><div class="sports volleyball"></div><span><?=getTranslation('mobilvoleybol')?></span></div>
<? } ?>
...
if(val==1){
	...
	$.get('export.php?a=livesearch_arama&sportip=4&aranan_takim='+aranan_takim+'',function(data) {
...
function loadbulten() {
$("#loadbulten").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$.get('export.php?a=voleybolbulten&ulke=<?=$_GET['ulke'];?>',function(data) {
