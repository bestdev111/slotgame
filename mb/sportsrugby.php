...
if(userayar('rugby')!="1") { header("Location:/mb"); }
?>
...
<? } ?>
<? if(userayar('rugby')=="1") { ?>
<div class="icon selected" onclick="getle('sport11')"><div class="sports rugby"></div><span><?=getTranslation('yeniyerler_kasa198')?></span></div>
<? } ?>
<? if(userayar('dovus')=="1") { ?>
...
function loadbulten() {
$("#loadbulten").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$.get('export.php?a=rugbybulten',function(data) {
