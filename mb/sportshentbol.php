...
if(userayar('hentbol')!="1") { header("Location:/mb"); }
?>
...
if(val==1){
	...
	$.get('export.php?a=livesearch_arama&sportip=6&aranan_takim='+aranan_takim+'',function(data) {
...
function loadbulten() {
$("#loadbulten").html('<div id="loading" class="old"><div class="spinner"><img src="assets/loading2.svg" class="loading" onload="displayImage(this)"></div><div class="logo"></div></div>');
$.get('export.php?a=hentbolbulten',function(data) {
