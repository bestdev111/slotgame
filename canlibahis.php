...
<script>
var oranlarkapatildiyazisi = '<?=getTranslation('oranlarkapatildi');?>';
var devreler1 = '<?=getTranslation('devreler1');?>';
var devreler2 = '<?=getTranslation('devreler2');?>';
var devreler3 = '<?=getTranslation('devreler3');?>';
var devreler4 = '<?=getTranslation('devreler4');?>';
var devreler5 = '<?=getTranslation('devreler5');?>';
var devreler6 = '<?=getTranslation('devreler6');?>';
var devreler7 = '<?=getTranslation('devreler7');?>';
var devreler8 = '<?=getTranslation('devreler8');?>';
var devreler9 = '<?=getTranslation('devreler9');?>';
var devreler10 = '<?=getTranslation('devreler10');?>';
var devreler11 = '<?=getTranslation('devreler11');?>';
var devreler12 = '<?=getTranslation('devreler12');?>';
var devreler13 = '<?=getTranslation('devreler13');?>';
var devreler14 = '<?=getTranslation('devreler14');?>';
var devreler15 = '<?=getTranslation('devreler15');?>';
var devreler16 = '<?=getTranslation('devreler16');?>';
var devreler17 = '<?=getTranslation('devreler17');?>';
var devreler18 = '<?=getTranslation('devreler18');?>';
var devreler19 = '<?=getTranslation('devreler19');?>';
var devreler20 = '<?=getTranslation('devreler20');?>';
var devreler21 = '<?=getTranslation('devreler21');?>';
var devreler22 = '<?=getTranslation('devreler22');?>';
var devreler23 = '<?=getTranslation('devreler23');?>';
var devreler24 = '<?=getTranslation('devreler24');?>';
var devreler25 = '<?=getTranslation('devreler25');?>';
var devreler26 = '<?=getTranslation('devreler26');?>';
var devreler27 = '<?=getTranslation('devreler27');?>';
var devreler28 = '<?=getTranslation('devreler28');?>';
var devreler29 = '<?=getTranslation('devreler29');?>';
var devreler30 = '<?=getTranslation('devreler30');?>';
var devreler31 = '<?=getTranslation('devreler31');?>';
var devreler32 = '<?=getTranslation('devreler32');?>';
var devreler33 = '<?=getTranslation('devreler33');?>';
var devreler34 = '<?=getTranslation('devreler34');?>';
var devreler35 = '<?=getTranslation('devreler35');?>';
var devreler36 = '<?=getTranslation('devreler36');?>';
var devreler37 = '<?=getTranslation('devreler37');?>';
var devreler38 = '<?=getTranslation('devreler38');?>';
var devreler39 = '<?=getTranslation('devreler39');?>';
var devreler40 = '<?=getTranslation('devreler40');?>';
var devreler41 = '<?=getTranslation('devreler41');?>';
var devreler42 = '<?=getTranslation('devreler42');?>';
var devreler43 = '<?=getTranslation('devreler43');?>';
var devreler44 = '<?=getTranslation('devreler44');?>';
var devreler45 = '<?=getTranslation('devreler45');?>';

var birvexo = '<?=getTranslation('oransecenek35');?>';
var xveikio = '<?=getTranslation('oransecenek36');?>';
var birveikio = '<?=getTranslation('oransecenek37');?>';


var dakikaicin = '<?=getTranslation('canlidkicin');?>';
var anlatimicin1 = '<?=getTranslation('canlianlatimicin1');?>';
var anlatimicin2 = '<?=getTranslation('canlianlatimicin2');?>';
var anlatimicin3 = '<?=getTranslation('canlianlatimicin3');?>';
var anlatimicin4 = '<?=getTranslation('canlianlatimicin4');?>';
var anlatimicin5 = '<?=getTranslation('canlianlatimicin5');?>';
var anlatimicin6 = '<?=getTranslation('canlianlatimicin6');?>';

var oransecenek1 = '<?=getTranslation('canlioransecenek1');?>';
var oransecenek2 = '<?=getTranslation('canlioransecenek2');?>';
var oransecenek3 = '<?=getTranslation('canlioransecenek3');?>';
var oransecenek4 = '<?=getTranslation('canlioransecenek4');?>';
var oransecenek5 = '<?=getTranslation('canlioransecenek5');?>';
var oransecenek6 = '<?=getTranslation('canlioransecenek6');?>';
var oransecenek7 = '<?=getTranslation('canlioransecenek7');?>';
var oransecenek8 = '<?=getTranslation('canlioransecenek8');?>';
...
$('#canlihrefdiv_1').addClass('seciliolancanli');
$('#basketboldivgoster').hide();
$('#canlihrefdiv_2').removeClass('seciliolancanli');
$('#tenisdivgoster').hide();
$('#canlihrefdiv_3').removeClass('seciliolancanli');
$('#voleyboldivgoster').hide();
$('#canlihrefdiv_4').removeClass('seciliolancanli');
$('#buzhokeyidivgoster').hide();
$('#canlihrefdiv_5').removeClass('seciliolancanli');
$('#masatenisdivgoster').hide();
$('#canlihrefdiv_6').removeClass('seciliolancanli');
$('#ustanlatimlar').show();
$('#ustanlatimlar2').hide();
} else if (div==2) {
$('#futboldivgoster').hide();
$('#canlihrefdiv_1').removeClass('seciliolancanli');
$('#tenisdivgoster').hide();
$('#canlihrefdiv_3').removeClass('seciliolancanli');
$('#basketboldivgoster').show();
$('#canlihrefdiv_2').addClass('seciliolancanli');
$('#voleyboldivgoster').hide();
$('#canlihrefdiv_4').removeClass('seciliolancanli');
$('#buzhokeyidivgoster').hide();
$('#canlihrefdiv_5').removeClass('seciliolancanli');
...
$('#canlihrefdiv_2').removeClass('seciliolancanli');
$('#tenisdivgoster').show();
$('#canlihrefdiv_3').addClass('seciliolancanli');
$('#voleyboldivgoster').hide();
$('#canlihrefdiv_4').removeClass('seciliolancanli');
$('#buzhokeyidivgoster').hide();
$('#canlihrefdiv_5').removeClass('seciliolancanli');
...
$('#canlihrefdiv_4').addClass('seciliolancanli');
$('#buzhokeyidivgoster').hide();
$('#canlihrefdiv_5').removeClass('seciliolancanli');
$('#masatenisdivgoster').hide();
$('#canlihrefdiv_6').removeClass('seciliolancanli');
...
$('#canlihrefdiv_5').addClass('seciliolancanli');
$('#masatenisdivgoster').hide();
$('#canlihrefdiv_6').removeClass('seciliolancanli');
$('#ustanlatimlar2').hide();
$('#ustanlatimlar').hide();
...
$('#buzhokeyidivgoster').hide();
$('#canlihrefdiv_5').removeClass('seciliolancanli');
$('#masatenisdivgoster').show();
$('#canlihrefdiv_6').addClass('seciliolancanli');
$('#ustanlatimlar2').hide();
$('#ustanlatimlar').hide();
}
...
<style>
#main_wide.lwkSelector table td.tab_2_select.on a.seciliolancanli {
    background: #7c7c7c;
}
</style>
...
<script type="text/javascript" src="/assets/js/Y_Live_Yeni972.js"></script>



<script type="text/javascript" src="/assets/js/loadmask.js"></script>
<script type="text/javascript" src="/assets/js/jquery.json.js"></script>
<script type="text/javascript" src="/assets/js/UHnWESdfrtgbOOkCCrtAzC.js"></script>
<script type="text/javascript" src="/assets/js/OnbVgaHkNgTjcXsUKGkimJiNgBSAD.js"></script>
<script type="text/javascript" src="/assets/js/dRVG_Yeni.js"></script>

<script data-autoInit="true" type="text/javascript" src="/assets/betradar/get?s=anajs"></script>
<script>
function closetvnow(){
	$('#livescore-close').hide().html('');
	window.SRLive.removeWidget("widgets.lmts",{showMomentum:"1",showMomentum2:"1",momentum2_type:"line",momentum2_showArea:"1",showPitch:"1",showSidebar:false,showGoalscorers:false,sidebarLayout:"dynamic",collapse_enabled:"1",collapse_startCollapsed:false,matchId:window.scoreboardId,showTitle:false,container:"#livescore-close"});
}
function showtvnow(radarid){
	$('#livescore-close').show();
	window.scoreboardId=radarid;
	window.scoreboardIdOld=radarid;
	window.SRLive.addWidget("widgets.lmts",{showMomentum:"1",showMomentum2:"1",momentum2_type:"line",momentum2_showArea:"1",showPitch:"1",showSidebar:false,showGoalscorers:false,sidebarLayout:"dynamic",collapse_enabled:"1",collapse_startCollapsed:false,matchId:window.scoreboardId,showTitle:false,container:"#livescore-close"});
}
</script>
<style>
#livescore-close {
...
<div id="main_wide" class="lwkSelector">
<div id="live" class="showBoards">
<div id="comp-liveConferenceFrame" class="e_active e_noCache ">
<div class="space_20"></div>
<div class="main_space">
<div class="e_active " id="comp-tabPanel" >
<div class="space_20"></div>
<table class="tab_box_2">
<tbody>
<tr>
<td class="tab_2_empty" style="position: relative;">

<input style="color:#999999;height: 32px;width: 198px;background: #fff;border: 1px solid #cecece;height: 34px;color: #000;font-size: 12px;font-weight: 500;padding: 0 10px;border-radius: 0;box-shadow: none;" autocomplete="off" class="form-control" type="text" id="livesearchinput" value="" placeholder="<?=getTranslation('yeniyerler_kasa454')?>" onclick="this.value='';SearchCloser();" onkeyup="Live.Search();">

<div id="live_ac_results" style="position: absolute;top: 32px;left: 0px;display: block;z-index: 9;background: #fff;width: 210px;" class="ng-scope"></div>

</td>
<td class="tab_2_select on"><a id="canlihrefdiv_1" class="seciliolancanli" href="javascript:canlitipgoster(1);"><?=getTranslation('canlibahisphp2')?></a></td>
<?php if(userayar('canlibasketbol')=="1") { ?>
<td class="tab_2_select on"><a id="canlihrefdiv_2" href="javascript:canlitipgoster(2);"><?=getTranslation('canlibahisphp3')?></a></td>
<?php } ?>
<?php if(userayar('canlitenis')=="1") { ?>
<td class="tab_2_select on"><a id="canlihrefdiv_3" href="javascript:canlitipgoster(3);"><?=getTranslation('canlibahisphp4')?></a></td>
<?php } ?>
<?php if(userayar('canlivoleybol')=="1") { ?>
<td class="tab_2_select on"><a id="canlihrefdiv_4" href="javascript:canlitipgoster(4);"><?=getTranslation('voleybol')?></a></td>
<?php } ?>
<?php if(userayar('canlibuzhokeyi')=="1") { ?>
<td class="tab_2_select on"><a id="canlihrefdiv_5" href="javascript:canlitipgoster(5);"><?=getTranslation('yeniyerler_kasa398')?></a></td>
<?php } ?>
<?php if(userayar('canlimasatenisi')=="1") { ?>
<td class="tab_2_select on"><a id="canlihrefdiv_6" href="javascript:canlitipgoster(6);"><?=getTranslation('yeniyerler_kasa397')?></a></td>
<?php } ?>

</tr>

<tr>
<td colspan="5" style="height: 30px; border: 1px solid #cccccc; border-top: 0">
<div class="e_active " id="_program_conference_goalbox_sectionType_all">

<div id="ustanlatimlar" class="tab_2_cont num_1 grey cf"></div>

<div id="ustanlatimlar2" class="tab_2_cont num_1 grey cf" style="display:none;"></div>
...
<div id="comp-myLiveEvents" class="e_active jq-rows-cont"></div>
<div class="e_active " id="comp-sectionsPanel" >
<div id="tab_cont_1" class="tab_cont">

<div id="futboldivgoster" class="main_space border_ccc jq-crosshair running">
<div class="e_active e_noCache jq-header-row" id="_program_conference_runningheader_sportId_soccer" >
<div class="jq-header">
<div class="row head_1 cf">
<div class="c_1"><img src="assets/img/sporticons/icon_soccer-1165587A803228C95E3B32D052349A1D.png" alt="<?=getTranslation('canlibahisphp2')?>" onmouseover="tip(\'<?=getTranslation('canlibahisphp2')?>\',0)" onmouseout="untip()" width="21" height="21"></div>
<div class="c_2 grey_555" style="width: 432px;"><span class="pad_l_9"><?=getTranslation('canlibahisphp2')?></span></div>
<div class="c_3 grey_555 bold jq-colCount_1"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphpfutbol1')?></div></div></div>
<div class="c_3 grey_555 bold jq-colCount_2"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphpfutbol2')?></div></div></div>
</div>
</div>
</div>

<div id="liveEventsRight"></div>

</div>

<div id="basketboldivgoster" style="display:none;" class="main_space border_ccc jq-crosshair running">
<div class="e_active e_noCache jq-header-row" id="_program_conference_runningheader_sportId_soccer" >
<div class="jq-header">
<div class="row head_1 cf">
<div class="c_1"><img src="assets/img/sporticons/icon_basketball-14F0349CADC3D7927A85A6B4AB7BF39D.png" alt="<?=getTranslation('canlibahisphp3')?>" onmouseover="tip(\'<?=getTranslation('canlibahisphp3')?>\',0)" onmouseout="untip()" width="21" height="21"></div>
<div class="c_2 grey_555" style="width: 382px;"><span class="pad_l_9"><?=getTranslation('canlibahisphp3')?></span></div>
<div class="c_3 grey_555 bold jq-colCount_1"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphpbasketbol1')?></div></div></div>
<div class="c_3 grey_555 bold jq-colCount_2" style="width: 185px;"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphpbasketbol2')?></div></div></div>
</div>
</div>
</div>

<?php if(userayar('canlibasketbol')=="1") { ?>
<div id="liveEventsRightb"></div>
<?php } ?>

</div>

<div id="tenisdivgoster" style="display:none;" class="main_space border_ccc jq-crosshair running">
<div class="e_active e_noCache jq-header-row" id="_program_conference_runningheader_sportId_soccer" >
<div class="jq-header">
<div class="row head_1 cf">
<div class="c_1"><img src="assets/img/sporticons/icon_tennis-9E6E475D6D707CEB3220ED2675F53E26.png" alt="<?=getTranslation('canlibahisphp4')?>" onmouseover="tip(\'<?=getTranslation('canlibahisphp4')?>\',0)" onmouseout="untip()" width="21" height="21"></div>
<div class="c_2 grey_555" style="width: 303px;"><span class="pad_l_9"><?=getTranslation('canlibahisphp4')?></span></div>
<div class="c_3 grey_555 bold jq-colCount_1" style="width: 85px;"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphptenis1')?></div></div></div>
<div class="c_3 grey_555 bold jq-colCount_2" style="width: 90px;"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphptenis2')?></div></div></div>
<div class="c_3 grey_555 bold jq-colCount_2" style="width: 95px;"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphptenis3')?></div></div></div>
<div class="c_3 grey_555 bold jq-colCount_2" style="width: 90px;"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphptenis4')?></div></div></div>
</div>
</div>
</div>

<?php if(userayar('canlitenis')=="1") { ?>
<div id="liveEventsRightt"></div>
<?php } ?>

</div>

<div id="voleyboldivgoster" style="display:none;" class="main_space border_ccc jq-crosshair running">
<div class="e_active e_noCache jq-header-row" id="_program_conference_runningheader_sportId_soccer" >
<div class="jq-header">
<div class="row head_1 cf">
<div class="c_1"><img src="assets/img/sporticons/icon_volleyball-B1C0CF0EFEB3127D0B629E2BE70D337A.png" alt="Voleybol" onmouseover="tip(\'Voleybol\',0)" onmouseout="untip()" width="21" height="21"></div>
<div class="c_2 grey_555" style="width: 362px;"><span class="pad_l_9"><?=getTranslation('playersligler11')?></span></div>
<div class="c_3 grey_555 bold jq-colCount_1" style="width: 90px;"><div class="wrap"><div class="text align_c"><?=getTranslation('voran1')?></div></div></div>
<div class="c_3 grey_555 bold jq-colCount_2" style="width: 230px;"><div class="wrap"><div class="text align_c"><?=getTranslation('voran3')?></div></div></div>
</div>
</div>
</div>

<?php if(userayar('canlivoleybol')=="1") { ?>
<div id="liveEventsRightv"></div>
<?php } ?>

</div>

<div id="buzhokeyidivgoster" style="display:none;" class="main_space border_ccc jq-crosshair running">
<div class="e_active e_noCache jq-header-row" id="_program_conference_runningheader_sportId_soccer" >
<div class="jq-header">
<div class="row head_1 cf">
<div class="c_1"><img src="assets/img/sporticons/icon_ice-hockey-BC31DBA3F14652F2DA362723E8D8C866.png" alt="Buz Hokeyi" onmouseover="tip(\'Buz Hokeyi\',0)" onmouseout="untip()" width="21" height="21"></div>
<div class="c_2 grey_555" style="width: 530px;"><span class="pad_l_9"><?=getTranslation('playersligler12')?></span></div>
<div class="c_3 grey_555 bold jq-colCount_1" style="width: 150px;"><div class="wrap"><div class="text align_c"><?=getTranslation('yeniyerler_kasa366')?></div></div></div>
</div>
</div>
</div>

<?php if(userayar('canlibuzhokeyi')=="1") { ?>
<div id="liveEventsRightbuz"></div>
<?php } ?>

</div>

<div id="masatenisdivgoster" style="display:none;" class="main_space border_ccc jq-crosshair running">
<div class="e_active e_noCache jq-header-row" id="_program_conference_runningheader_sportId_soccer" >
<div class="jq-header">
<div class="row head_1 cf">
<div class="c_1"><img src="assets/img/sporticons/icon_tennis-9E6E475D6D707CEB3220ED2675F53E26.png" alt="Masa Tenisi" onmouseover="tip(\'Masa Tenisi\',0)" onmouseout="untip()" width="21" height="21"></div>
<div class="c_2 grey_555" style="width: 517px;"><span class="pad_l_9"><?=getTranslation('yeniyerler_kasa397')?></span></div>
<div class="c_3 grey_555 bold jq-colCount_1" style="width: 85px;"><div class="wrap"><div class="text align_c"><?=getTranslation('canlibahisphptenis1')?></div></div></div>
</div>
</div>
</div>
...
<div class="space_20 seperator"></div>
<div class="space_9"></div>
...
<tbody>
<tr>
<td id="tooltip_3_tl"></td>
<td id="tooltip_3_tr"></td>
</tr>
<tr> 
<td id="tooltip_3_bl"></td>
<td id="tooltip_3_br"></td>
</tr>
</tbody>
</table>
</div>
...
<script type="text/javascript">
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2','futbol')==0){ ?>Live.agames[17]=1;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Handikap 1:0','futbol')==0){ ?>Live.agames[54]=2;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Handikap 2:0','futbol')==0){ ?>Live.agames[502]=3;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Handikap 0:1','futbol')==0){ ?>Live.agames[52]=9;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Handikap 0:2','futbol')==0){ ?>Live.agames[501]=10;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Çifte Şans','futbol')==0){ ?>Live.agames[3187]=16;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Çifte Şans','futbol')==0){ ?>Live.agames[11748]=17;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı 0.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[7688]=20;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı 1.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[7689]=13;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı 2.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[7890]=22;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam 0.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[7233]=26;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam 1.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[1772]=27;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam 2.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[173]=28;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam 3.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[8933]=29;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam 4.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[1791]=30;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam 5.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[859]=31;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı 0.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[19595]=36;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı 1.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[19596]=37;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı 2.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[19597]=38;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı 3.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[20506]=39;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Karşılıklı Gol Olurmu ?','futbol')==0){ ?>Live.agames[7824]=45;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi Müsabakada Gol Atarmı ?','futbol')==0){ ?>Live.agames[11087]=46;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman Müsabakada Gol Atarmı ?','futbol')==0){ ?>Live.agames[11086]=47;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Gol Tek / Çift','futbol')==0){ ?>Live.agames[4665]=54;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Tek / Çift','futbol')==0){ ?>Live.agames[16449]=55;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Karşılıklı Gol','futbol')==0){ ?>Live.agames[15085]=44;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Maç Sonucu ve Karşılıklı Gol','futbol')==0){ ?>Live.agames[24392]=138;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi 0.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[20083]=56;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi 1.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[16454]=57;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi 2.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[24138]=58;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman 0.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[20084]=62;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman 1.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[16455]=63;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman 2.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[20085]=64;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Kaç Gol Atılır ?','futbol')==0){ ?>Live.agames[2196]=88;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi Toplam Kaç Gol Atar ?','futbol')==0){ ?>Live.agames[4726]=96;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman Toplam Kaç Gol Atar ?','futbol')==0){ ?>Live.agames[4727]=97;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Skoru','futbol')==0){ ?>Live.agames[26644]=101;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Maç Skoru','futbol')==0){ ?>Live.agames[19193]=102;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi 1.Yarı 0.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[31316]=129;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi 1.Yarı 1.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[31317]=130;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi 1.Yarı 2.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[31318]=131;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman 1.Yarı 0.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[31319]=133;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman 1.Yarı 1.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[31320]=134;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman 1.Yarı 2.5 Gol Alt Üst','futbol')==0){ ?>Live.agames[31321]=135;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi İlk Yarı Tam Gol Sayısı','futbol')==0){ ?>Live.agames[4720]=139;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Ev Sahibi İkinci Yarı Tam Gol Sayısı','futbol')==0){ ?>Live.agames[4733]=140;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman İlk Yarı Tam Gol Sayısı','futbol')==0){ ?>Live.agames[4721]=141;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Deplasman İkinci Yarı Tam Gol Sayısı','futbol')==0){ ?>Live.agames[4734]=142;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Herhangi Bir Takım 1 Gol Farkla Kazanirmi ?','futbol')==0){ ?>Live.agames[19508]=143;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Herhangi Bir Takım 2 Gol Farkla Kazanirmi ?','futbol')==0){ ?>Live.agames[19509]=144;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Herhangi Bir Takım 3 Gol Farkla Kazanirmi ?','futbol')==0){ ?>Live.agames[19510]=145;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Sonucu','futbol')==0){ ?>Live.agames[2488]=18;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı Sonucu','futbol')==0){ ?>Live.agames[4778]=146;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'İlk Yarıda Kaç Gol Olur ?','futbol')==0){ ?>Live.agames[27536]=158;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarıda Toplam Kaç Gol Olur ?','futbol')==0){ ?>Live.agames[4732]=147;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Müsabakada kaç gol atılır? (0-4 )','futbol')==0){ ?>Live.agames[27531]=167;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Müsabakada kaç gol atılır? (0-5 )','futbol')==0){ ?>Live.agames[27534]=168;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Müsabakada kaç gol atılır? (0-6 )','futbol')==0){ ?>Live.agames[27535]=169;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1. yarıda 1.golü hangi takım atar?','futbol')==0){ ?>Live.agames[4956]=85;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1. yarıda 2.golü hangi takım atar?','futbol')==0){ ?>Live.agames[13461]=127;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.golü hangi takım atar?','futbol')==0){ ?>Live.agames[118]=73;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.golü hangi takım atar?','futbol')==0){ ?>Live.agames[1344]=74;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.golü hangi takım atar?','futbol')==0){ ?>Live.agames[1345]=75;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.golü hangi takım atar?','futbol')==0){ ?>Live.agames[1346]=76;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'5.golü hangi takım atar?','futbol')==0){ ?>Live.agames[1347]=77;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'6.golü hangi takım atar?','futbol')==0){ ?>Live.agames[1348]=78;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 5.5 Alt/Üst','futbol')==0){ ?>Live.agames[4523]=15000;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 6.5 Alt/Üst','futbol')==0){ ?>Live.agames[4524]=15001;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 7.5 Alt/Üst','futbol')==0){ ?>Live.agames[4525]=15002;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 8.5 Alt/Üst','futbol')==0){ ?>Live.agames[4526]=15003;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 9.5 Alt/Üst','futbol')==0){ ?>Live.agames[4527]=15004;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 10.5 Alt/Üst','futbol')==0){ ?>Live.agames[4528]=15005;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 11.5 Alt/Üst','futbol')==0){ ?>Live.agames[4529]=15006;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 12.5 Alt/Üst','futbol')==0){ ?>Live.agames[4530]=15007;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 13.5 Alt/Üst','futbol')==0){ ?>Live.agames[4531]=15008;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 14.5 Alt/Üst','futbol')==0){ ?>Live.agames[4532]=15009;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Korner 15.5 Alt/Üst','futbol')==0){ ?>Live.agames[4533]=15010;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Sarı Kart 1.5 Alt/Üst','futbol')==0){ ?>Live.agames[9922]=15011;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Sarı Kart 2.5 Alt/Üst','futbol')==0){ ?>Live.agames[9923]=15012;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Sarı Kart 3.5 Alt/Üst','futbol')==0){ ?>Live.agames[9924]=15013;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Sarı Kart 4.5 Alt/Üst','futbol')==0){ ?>Live.agames[9925]=15014;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Kırmızı Kart Çıkarmı ?','futbol')==0){ ?>Live.agames[19976]=15015;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Kaç Penaltı Olur ?','futbol')==0){ ?>Live.agames[1328]=15016;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Sarı Kart 1.5 Alt/Üst','futbol')==0){ ?>Live.agames[18739]=15017;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Sarı Kart 2.5 Alt/Üst','futbol')==0){ ?>Live.agames[187398]=15018;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Sarı Kart 3.5 Alt/Üst','futbol')==0){ ?>Live.agames[187399]=15019;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Sarı Kart 1.5 Alt/Üst','futbol')==0){ ?>Live.agames[18740]=15020;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Sarı Kart 2.5 Alt/Üst','futbol')==0){ ?>Live.agames[187408]=15021;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Sarı Kart 3.5 Alt/Üst','futbol')==0){ ?>Live.agames[187409]=15022;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Sarı Kart Tek/Çift','futbol')==0){ ?>Live.agames[17929]=15023;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Hangi Takım Çok Sarı Kart Yer ?','futbol')==0){ ?>Live.agames[4753]=15024;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 2.5 Alt/Üst','futbol')==0){ ?>Live.agames[4784]=15025;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 3.5 Alt/Üst','futbol')==0){ ?>Live.agames[47841]=15026;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 4.5 Alt/Üst','futbol')==0){ ?>Live.agames[47842]=15027;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 5.5 Alt/Üst','futbol')==0){ ?>Live.agames[47843]=15028;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 6.5 Alt/Üst','futbol')==0){ ?>Live.agames[47844]=15029;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 7.5 Alt/Üst','futbol')==0){ ?>Live.agames[47845]=15030;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 8.5 Alt/Üst','futbol')==0){ ?>Live.agames[47846]=15031;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 9.5 Alt/Üst','futbol')==0){ ?>Live.agames[47847]=15032;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Korner 10.5 Alt/Üst','futbol')==0){ ?>Live.agames[47848]=15033;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 2.5 Alt/Üst','futbol')==0){ ?>Live.agames[4785]=15034;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 3.5 Alt/Üst','futbol')==0){ ?>Live.agames[47851]=15035;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 4.5 Alt/Üst','futbol')==0){ ?>Live.agames[47852]=15036;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 5.5 Alt/Üst','futbol')==0){ ?>Live.agames[47853]=15037;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 6.5 Alt/Üst','futbol')==0){ ?>Live.agames[47854]=15038;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 7.5 Alt/Üst','futbol')==0){ ?>Live.agames[47855]=15039;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 8.5 Alt/Üst','futbol')==0){ ?>Live.agames[47856]=15040;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 9.5 Alt/Üst','futbol')==0){ ?>Live.agames[47857]=15041;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Korner 10.5 Alt/Üst','futbol')==0){ ?>Live.agames[47858]=15042;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Korner Tek/Çift','futbol')==0){ ?>Live.agames[17925]=15043;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Hangi Takım Daha Çok Korner Kullanır ?','futbol')==0){ ?>Live.agames[4793]=15044;<?php } ?>



<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2','basketbol')==0){ ?>Live.agames[15025]=1;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2(1.YARI)','basketbol')==0){ ?>Live.agames[19849]=18;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2(2.YARI)','basketbol')==0){ ?>Live.agames[31511]=146;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Kim Kazanır','basketbol')==0){ ?>Live.agames[66]=170;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Çeyrek Kim Kazanır','basketbol')==0){ ?>Live.agames[14610]=194;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Çeyrek Kim Kazanır','basketbol')==0){ ?>Live.agames[20127]=195;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.Çeyrek Kim Kazanır','basketbol')==0){ ?>Live.agames[20128]=182;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.Çeyrek Kim Kazanır','basketbol')==0){ ?>Live.agames[20129]=196;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Skor Alt/Üst','basketbol')==0){ ?>Live.agames[102]=172;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Çeyrek Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[7356]=181;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Çeyrek Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[17588]=185;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.Çeyrek Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[17589]=180;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.Çeyrek Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[17590]=186;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Handikap','basketbol')==0){ ?>Live.agames[7699]=184;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Çeyrek Handikap','basketbol')==0){ ?>Live.agames[7332]=2801;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Çeyrek Handikap','basketbol')==0){ ?>Live.agames[7357]=2802;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.Çeyrek Handikap','basketbol')==0){ ?>Live.agames[11306]=2803;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.Çeyrek Handikap','basketbol')==0){ ?>Live.agames[2837]=2804;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Çeyrek Toplam Tek/Çift','basketbol')==0){ ?>Live.agames[12140]=162;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Çeyrek Toplam Tek/Çift','basketbol')==0){ ?>Live.agames[12141]=163;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.Çeyrek Toplam Tek/Çift','basketbol')==0){ ?>Live.agames[12142]=164;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.Çeyrek Toplam Tek/Çift','basketbol')==0){ ?>Live.agames[12143]=165;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Tek/Çift','basketbol')==0){ ?>Live.agames[7970]=148;<?php } ?>


//BASKETBOL İÇİN//
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2(1.Çeyrek)','basketbol')==0){ ?>Live.agames[31512]=2805;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2(2.Çeyrek)','basketbol')==0){ ?>Live.agames[31513]=2806;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2(3.Çeyrek)','basketbol')==0){ ?>Live.agames[31514]=2807;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2(4.Çeyrek)','basketbol')==0){ ?>Live.agames[31515]=2808;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[12426]=2809;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[18191]=2810;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım 1.Yarı Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[12811]=2811;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım 1.Yarı Toplam Alt/Üst','basketbol')==0){ ?>Live.agames[18188]=2812;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Handikap','basketbol')==0){ ?>Live.agames[7698]=2800;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı Handikap','basketbol')==0){ ?>Live.agames[11305]=2813;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Toplam Tek/Çift','basketbol')==0){ ?>Live.agames[12173]=149;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı Toplam Tek/Çift','basketbol')==0){ ?>Live.agames[12174]=2814;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Yarı Kim Kazanır','basketbol')==0){ ?>Live.agames[13974]=2815;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Yarı Kim Kazanır','basketbol')==0){ ?>Live.agames[7764]=183;<?php } ?>
//BASKETBOL İÇİN//

//VOLEYBOL İÇİN//
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Kim Kazanır','voleybol')==0){ ?>Live.agames[1545]=6000;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Seti Kim Kazanır ?','voleybol')==0){ ?>Live.agames[1547]=6001;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Seti Kim Kazanır ?','voleybol')==0){ ?>Live.agames[8263]=6002;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.Seti Kim Kazanır ?','voleybol')==0){ ?>Live.agames[1550]=6003;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.Seti Kim Kazanır ?','voleybol')==0){ ?>Live.agames[1551]=6004;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Set bahisi (5 maç üzerinden)','voleybol')==0){ ?>Live.agames[499]=6005;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Kaç Set Oynanır ?','voleybol')==0){ ?>Live.agames[6355]=6006;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31887]=6007;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31894]=6008;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım 1.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31881]=6009;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım 1.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31888]=6010;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım 2.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31882]=6011;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım 2.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31889]=6012;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım 3.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31883]=6013;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım 3.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31890]=6014;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Takım 4.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31884]=6015;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Takım 4.Set Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[31891]=6016;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Sayı Alt/Üst','voleybol')==0){ ?>Live.agames[9210]=6017;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Toplam Sayı Tek/Çift','voleybol')==0){ ?>Live.agames[14437]=6018;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Set Toplam Sayı Tek/Çift','voleybol')==0){ ?>Live.agames[11950]=6019;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Set Toplam Sayı Tek/Çift','voleybol')==0){ ?>Live.agames[11951]=6020;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.Set Toplam Sayı Tek/Çift','voleybol')==0){ ?>Live.agames[11952]=6021;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.Set Toplam Sayı Tek/Çift','voleybol')==0){ ?>Live.agames[11953]=6022;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Müsabaka 5.Set Sürermi','voleybol')==0){ ?>Live.agames[14484]=6023;<?php } ?>
//VOLEYBOL İÇİN//

//BUZHOKEYİ İÇİN//
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1X2','buzhokeyi')==0){ ?>Live.agames[51]=6024;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Cifte Sans','buzhokeyi')==0){ ?>Live.agames[14464]=6025;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Hangi periyod daha cok gol olur?','buzhokeyi')==0){ ?>Live.agames[2771]=6026;<?php } ?>
//BUZHOKEYİ İÇİN//

//MASA TENİSİ İÇİN//
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Kim Kazanır','masatenis')==0){ ?>Live.agames[5421]=6027;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'Set Bahisi','masatenis')==0){ ?>Live.agames[17547]=6028;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'1.Seti Kim Kazanır','masatenis')==0){ ?>Live.agames[5424]=6029;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'2.Seti Kim Kazanır','masatenis')==0){ ?>Live.agames[8261]=6030;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'3.Seti Kim Kazanır','masatenis')==0){ ?>Live.agames[5426]=6031;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'4.Seti Kim Kazanır','masatenis')==0){ ?>Live.agames[5427]=6032;<?php } ?>
<?php if(canlida_oran_yasaklimi($ayar_id_ver,'5.Seti Kim Kazanır','masatenis')==0){ ?>Live.agames[5428]=6033;<?php } ?>
//MASA TENİSİ İÇİN//

Live.agames[5421]=170;Live.agames[2]=12;Live.agames[17547]=1511;Live.agames[3]=13;Live.agames[7891]=13;Live.agames[20087]=59;Live.agames[20088]=65;Live.agames[20090]=66;Live.agames[5424]=1500;Live.agames[8261]=1503;Live.agames[5426]=1505;Live.agames[62]=170;Live.agames[480]=1505;Live.agames[79]=1502;Live.agames[8695]=1503;Live.agames[635]=11;Live.agames[12119]=19;Live.agames[7689]=21;Live.agames[27542]=24;Live.agames[27543]=25;Live.agames[7891]=23;Live.agames[313]=32;Live.agames[1383]=3333;Live.agames[322]=3334;Live.agames[13462]=128;Live.agames[21077]=1800;Live.agames[21078]=1801;Live.agames[21079]=1802;Live.agames[21080]=1803;Live.agames[21081]=1804;Live.agames[21082]=1805;Live.agames[21056]=1806;Live.agames[21057]=1807;Live.agames[21058]=1808;Live.agames[21059]=1809;Live.agames[21060]=1810;Live.agames[21061]=1811;Live.agames[21062]=1812;Live.agames[21063]=1813;Live.agames[21064]=1814;Live.agames[21065]=1815;Live.agames[21092]=1816;Live.agames[21093]=1817;Live.agames[21094]=1818;Live.agames[21095]=1819;Live.agames[21096]=1820;Live.agames[21097]=1821;Live.agames[21098]=1822;Live.agames[21099]=1823;Live.agames[21101]=1824;Live.agames[21102]=1825;
...
$('#live_ac_results').hide().html('');
}

function anlatimlar(liveid,tip) {

if(tip=="1"){
	$('#anlatimsiz'+liveid).show();
	$('#anlatimsiz1'+liveid).addClass('selected');
	$('#anlatimli'+liveid).hide();
	$('#anlatimli1'+liveid).removeClass('selected');
} else {
	$('#anlatimsiz'+liveid).hide();
	$('#anlatimsiz1'+liveid).removeClass('selected');
	$('#anlatimli'+liveid).show();
	$('#anlatimli1'+liveid).addClass('selected');
}

}

function ChangeScoreBoardCanli(tip,liveid,keys,evtakim,deptakim) {
...
if(tip=="1"){
	...
	$('#statsdiv_'+liveid).hide();
	$('#livescoreboard').show();
	$('#livescore-close').html('<iframe class="livescoreframe36" src="https://href.li/?https://secure.nesine.performgroup.com/streaming/watch/event/index.html?userId=pauline&partnerId=1945&eventId=' + keys + '&streamOnly=false&statsswitch=false&homeTeam=' + evtakim.replace(' ', '%c2%a0') + '&awayTeam=' + deptakim.replace(' ', '%c2%a0') + '&width=500&lang=tr&version=1.22" id="livescoreframe" hspace="0" vspace="0" marginheight="0" marginwidth="0" scrolling="no" style="display: block;width:500px;height:365px;margin-left:120px" frameborder="0"></iframe>');
} else {
