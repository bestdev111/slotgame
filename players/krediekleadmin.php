...
if($ub['alt_alt_durum']!=1) { header("Location:index.php"); }
...
$alt_sinirini_bul2 = $ub['alt_sinir_2']-$toplams_limitm['toplam_limitm'];
...
<? if($onaylandi==1) { ?>
<div class="infomsg" onclick="javascript:$(this).hide();"><?=getTranslation('playerskrediekleadmin1')?></div>
<? } else if($onaylandi==2) { ?>
<div class="infomsg" onclick="javascript:$(this).hide();"><?=getTranslation('playerskrediekleadmin2')?></div>
<? } else if($onaylandi==3) { ?>
<div class="infomsg" onclick="javascript:$(this).hide();"><?=getTranslation('playerskrediekleadmin3')?></div>
<? } else if($onaylandi==4) { ?>
<div class="infomsg" onclick="javascript:$(this).hide();"><?=getTranslation('playerskrediekleadmin4')?></div>
<? } else if($onaylandi==5) { ?>
<div class="infomsg" onclick="javascript:$(this).hide();"><?=getTranslation('playerskrediekleadmin5')?></div>
<? } else if($onaylandi==6) { ?>
<div class="infomsg" onclick="javascript:$(this).hide();"><?=getTranslation('playerskrediekleadmin6')?> <?=$alt_sinirini_bul2;?> <?=getTranslation('playerskrediekleadmin7')?></div>
<? } ?>
...
<thead>
<tr>
<th colspan="2"><?=getTranslation('playerskrediekleadmin8')?></th>
</tr>
</thead>
<tbody>
<tr>
<td width="200"><?=getTranslation('playerskrediekleadmin9')?></td>
<td>
<?
...
<tr>
<td width="200"><?=getTranslation('playerskrediekleadmin10')?></td>
<td>
<select class="inputCombo choiceChosen" style="width:150px;" tabindex="3" id="tip" name="tip">
<option value="islemsec">----------------</option>
<option value="ekle"><?=getTranslation('playerskrediekleadmin11')?></option>
<option value="cikar"><?=getTranslation('playerskrediekleadmin12')?></option>
</select>
</td>
</tr>
<tr>
<td width="200"><?=getTranslation('playerskrediekleadmin13')?></td>
<td>
...
<li><?=getTranslation('playerskrediekleadmin14')?></li>
<li><?=getTranslation('playerskrediekleadmin15')?></li>
<li><?=getTranslation('playerskrediekleadmin16')?></li>
</ul>
</div>
</td>
</tr>
...
<input class="btn btn-large btn-primary2" type="submit" name="submit" style="width:100%;" class="button" value="<?=getTranslation('playerskrediekleadmin17')?>">
</td>
</tr>
</tbody>
</table>
...
<thead>
<tr>
<th colspan="8"><?=getTranslation('playerskrediekleadmin18')?></th>
</tr>
<tr>
<th><?=getTranslation('playerskrediekleadmin19')?></th>
<th><?=getTranslation('playerskrediekleadmin20')?></th>
<th><?=getTranslation('playerskrediekleadmin21')?></th>
</tr>
</thead>
<tbody>
...
<? } else { ?>
<tr class="itext-3" style="text-align:center;">
<td colspan="3"><?=getTranslation('playerskrediekleadmin22')?></td>
</tr>
<? } ?>
