...
<script>
$("#cbakiyeraporu").addClass("activemnuitems");
</script>
...
<td class="filtersCell1 c" style="width:90px" nowrap=""></td>

<td class="filtersCell1 l" style="width:90px" nowrap="">
<button class="btn btn-primary" onclick="raporgetir(1,1,'<?=$dil_bilgisi['language'];?>');"><?=getTranslation('mobilara')?></button>
</td>
...
<script>
function raporgetir(val, sayfaveri, dil) {
if(val=="1") {
$("#suanval").val(1);
...
$.get('../ajax_players.php?a=cbakiyeraporum&sayfa='+sayfaveri+'&tarih1='+tarih1+'&tarih2='+tarih2+'&islemtip='+islemtip+'&dil='+dil+'',function(data) { $("#kupons").html(data); });
}
$(document).ready(function(e) {
raporgetir(1,1,'<?=$dil_bilgisi['language'];?>');
});
</script>
