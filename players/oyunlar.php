...
<script>$("#oyunlar").addClass("activemnuitems");</script>
...
<select class="inputCombo chosen" onChange="oyunturleri($(this).val());">
...
<li><?=getTranslation('ajaxoyunturleri13')?></li>
<li><?=getTranslation('ajaxoyunturleri14')?></li>
<li><?=getTranslation('ajaxoyunturleri15')?></li>
</ul>
</div>
</td>
</tr>
...
<script>
function oyunturleri(tip) {
$("#oyunturleri").html('<div id="delay_layer" class="overlay_layer"><div class="innerWrap"><div class="contentBlock"><div class="headline"><?=getTranslation('lutfen1')?> <span class="highlighted"><?=getTranslation('lutfen2')?></span></div><div class="bodyText"><?=getTranslation('lutfen3')?></div><div class="progressbar"><div class="progressbarInner"></div></div></div></div></div>');
var rand = Math.random();
$.get('../ajax_players.php?a=oyun_turleri&tip='+tip+'&rand='+rand+'',function(data) { 
$("#oyunturleri").html(data);
});	
}
