...
<script>$("#kuponlarim").addClass("activemnuitems");</script>
...
<option value="1"><?=getTranslation('ajaxtoplumbs13')?></option>
<option value="2"><?=getTranslation('ajaxtoplumbs14')?></option>
<option value="3"><?=getTranslation('ajaxtoplumbs15')?></option>
<option value="4"><?=getTranslation('ajaxtoplumbs16')?></option>
<option value="5"><?=getTranslation('ajaxtoplumbs17')?></option>
<option value="6"><?=getTranslation('yeniyerler_kasa180')?></option>
...
<option value="12"><?=getTranslation('yeniyerler_kasa179')?></option>
<option value="13"><?=getTranslation('yeniyerler_kasa197')?></option>
<option value="14"><?=getTranslation('yeniyerler_kasa198')?></option>
<option value="15"><?=getTranslation('yeniyerler_kasa199')?></option>
<option value="16"><?=getTranslation('selectoptionsanalfutbol')?></option>
</select>
</div>
...
<div class="drop_box" style="padding: 0px;float: right;">
...
$.get('../ajax_players.php?a=kupond&id='+id+'&rand='+rand+'',function(data) { $(".kuponici").html(data); });
}
...
$(".kuponici").html('<div id="delay_layer" class="overlay_layer"><div class="innerWrap"><div class="contentBlock" style="border: dashed;border-color: #f74835;"><div class="headline"><?=getTranslation('lutfen1')?> <span class="highlighted"><?=getTranslation('lutfen2')?></span></div><div class="bodyText"><?=getTranslation('lutfen3')?></div><div class="progressbar"><div class="progressbarInner"></div></div></div></div></div>');
var rand = Math.random();
$.get('../ajax_players.php?a=kupondsanal&id='+id+'&rand='+rand+'',function(data) { $(".kuponici").html(data); });
}
...
$.get('../ajax_players.php?a=kuponlarim&sayfa='+sayfaveri+'&rand='+rand+'&kupon_no='+kupon_no+'&tarih1='+tarih1+'&tarih2='+tarih2+'&satir='+satir+'&durum='+durum+'&tip='+tip+'&kupon_sure='+kupon_sure+'&order='+order+'&ascdesc='+asde+'',function(data) {  $("#kupons").html(data); loadexit(); });
}
function loadall() {
$("#loadall").show();
...
$(".kuponici2").html('<div id="cboxWrapper" style="height: 256px;width: 400px;border: 20px #0009 solid;"><div style="clear: left;"><div id="cboxMiddleLeft" style=""></div><div id="cboxContent" style="float: left; width: 400px; height: 255px;"><div id="cboxLoadedContent" style="width: 400px;overflow: auto;height: 230px;"><div class="archive-player"><video class="is-playing" controls="" controlslist="nodownload" playsinline="" disablepictureinpicture="" style="width: 400px;height: 225px;" autoplay=""><source src="'+video+'" type="video/mp4"></video></div></div><div id="cboxLoadingOverlay" style="float: left; display: none;"></div><div id="cboxLoadingGraphic" style="float: left; display: none;"></div><div id="cboxTitle" style="float: left; display: block;">'+round+' Seans Videosu İzleniyor.</div><div id="cboxCurrent" style="float: left; display: none;"></div><div id="cboxNext" style="float: left; display: none;"></div><div id="cboxPrevious" style="float: left; display: none;"></div><div id="cboxSlideshow" style="float: left; display: none;"></div><div onclick="kuponkapat2();" id="cboxClose" style="float: left;"></div></div><div id="cboxMiddleRight" style="float: left; height: 255px;"></div></div><div style="clear: left;"><div id="cboxBottomLeft" style="float: left;"></div><div id="cboxBottomCenter" style="float: left; width: 400px;"></div><div id="cboxBottomRight" style="float: left;"></div></div></div>');
}
</script>
